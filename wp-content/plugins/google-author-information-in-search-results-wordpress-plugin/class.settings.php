...
class GPAISRSettings {
	...
	<!-- Google+ Button -->
	<p>
	<div class="g-plusone" data-size="medium" data-annotation="inline" data-href="http://wp-buddy.com/products/plugins/google-authorship-wordpress-plugin/"></div></p>
	...
	public function metabox_discover( $data ) {
		?>
	<a href="http://bit.ly/Wn88bZ" target="_blank"><img src="https://sslsites.de/social2business.com/wp-content/uploads/2012/10/affiliate.jpg" border="0" alt="" /></a>
	<?php
	}
	...
	<ul>
		...
		<li><a href="http://wordpress.org/support/plugin/google-author-information-in-search-results-wordpress-plugin" target="_blank"><?php echo __( 'Support forum', 'gpaisr' ); ?></a></li>
		<li><a href="http://wordpress.org/extend/plugins/google-author-information-in-search-results-wordpress-plugin/changelog/" target="_blank"><?php echo __( 'Changelog', 'gpaisr' ); ?></a></li>
		<li><a href="http://bit.ly/ZaaM8S" target="_blank"><?php echo __( 'Get the full version', 'gpaisr' ); ?></a></li>
		<li><a href="http://bit.ly/UlDG4t" target="_blank"><?php echo __( 'More cool stuff by WPBuddy', 'gpaisr' ); ?></a></li>
	</ul>
	<?php
	}
}
