<?php get_header() ?>
	...
	<div id="container">
		<div id="content" class="hfeed">
			<h2 class="page-title"><?php _e('Category Archives:', 'sandbox') ?> <?php single_cat_title(); ?></h2>
...
<?php while (have_posts()) : the_post(); ?>
			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class(); ?>">
				<h3 class="entry-title"><a href="<?php the_permalink() ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'sandbox' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title() ?></a></h3>
