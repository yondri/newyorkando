 ...
 * @since zBench 1.0
 */
wp_register_style( 'zbench', get_bloginfo( 'template_directory' ) . '/theme-options.css', '', '0.1' );
...
function zbench_default_options() {
	...
	if ( ! isset( $options['theme_layout'] ) ) {
		...
		update_option( 'zbench_theme_options', $options );
	}
}
...
function zbench_theme_options_do_page() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<?php $options = get_option( 'zbench_theme_options' ); ?>
