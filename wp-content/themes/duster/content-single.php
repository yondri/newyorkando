...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-meta">
			<?php
				printf( __( '<span class="sep">Posted on </span><a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s" pubdate>%3$s</time></a> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s">%6$s</a></span>', 'duster' ),
					...
					sprintf( esc_attr__( 'View all posts by %s', 'duster' ), get_the_author() ),
					get_the_author()
				);
			?>
		</div><!-- .entry-meta -->
	...
	<footer class="entry-meta">
		<?php
			...
			if ( '' != $tag_list ) {
				$utility_text = __( 'This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'duster' );
			} else {
				$utility_text = __( 'This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'duster' );
			}
			printf(
				$utility_text,
