	...
	<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>" >
		<div class="comment-box clear">
			<div class="c-grav">
				...
				<div class="c-date"><?php comment_date( get_option( 'date_format' ) ); ?></span></div>
			</div>
			<div class="c-body">
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<p><?php _e( '<em><strong>Please Note:</strong> Your comment is awaiting moderation.</em>', 'traction' ); ?></p>
				<?php endif; ?>
				<?php comment_text(); ?>
