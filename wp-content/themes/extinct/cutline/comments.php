	...
	<?php if (comments_open()) : ?>
		...
		<?php else : ?>
			...
			<?php } ?>
				...
				<p>
				<input name="submit" class="form_submit" type="submit" id="submit" src="<?php bloginfo('template_url') ?>/images/submit_comment.gif" tabindex="5" value="<?php esc_attr_e( 'Submit', 'cutline' ); ?>" />
