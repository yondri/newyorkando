            ...
            <?php if ( $postcount <= get_option('inuitypes_featured_entries') && ! is_paged() ) { ?>
                ...
                <div class="featured_post feat_background fl">
                	...
                	$image[1] >= 600 ) : ?>
                     	...
                     	<a title="<?php _e( 'Link to ', 'it' ); ?><?php the_title_attribute(); ?>" href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'one-column-feature' ); ?></a>               
                	...
                	$image[1] >= 278 ) : ?>
                     	...
                     	<a title="<?php _e( 'Link to ', 'it' ); ?><?php the_title_attribute(); ?>" href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'two-column-feature' ); ?></a>   
  						<span class="date_bg"><?php the_time( get_option( "date_format" ) ); ?></span>                 	
                	...
                	<?php endif; ?>
                        ...
                        <div class="featured_content">
							...
							<a title="<?php _e( 'Permanent link to ', 'it' ); ?><?php the_title_attribute(); ?>" href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a>
		...
		<!-- Rest of Entries: START -->
            ...
            <div class="post">
				...
				<?php if ( has_post_thumbnail() ) : ?>
                        ...
                        <a title="<?php _e( 'Link to ', 'it' ); ?><?php the_title_attribute(); ?>" href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'it-thumbnail' ); ?></a>          	
