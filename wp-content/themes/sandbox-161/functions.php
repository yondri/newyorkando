...
function sandbox_change_notice() {
	$theme_link = admin_url() . 'themes.php?s=sandbox-162';
?>
	<div class="updated">
		<p style="line-height: 1.5em;">Howdy! There's a new version of the Sandbox theme you&rsquo;re using on this blog&mdash;now with the new <a href="http://en.support.wordpress.com/menus" title="Custom Menus">custom menu feature</a>. Check out <a href="<?php echo $theme_link; ?>">Sandbox 1.6.2</a> in <em>Appearance &rarr; Themes</em>.</p>
	</div>
<?php
}
remove_action( 'admin_notices', 'show_tip' );
add_action( 'admin_notices', 'sandbox_change_notice' );
