    ...
    <body class="page">
        <div id="screen">
            ...
            <section class="G4 GR GS" id="content">
                <article>
                    <header>
                        <h1><?php _e('File Not Found', 'ia3'); ?></h1>
                    </header>
                    <div class="formatted">
                        <h2><?php _e('Oops, Not Found!', 'ia3'); ?></h2>
            			<p><?php _e('Sorry, we were unable to find the page you were looking for.', 'ia3'); ?></p>
            			<ul>
            			    <li><a href="<?php echo (defined('WP_SITEURL'))? WP_SITEURL: get_bloginfo('url'); ?>"><?php _e('Return to the home page.', 'ia3'); ?></a></li>
            			</ul>
                    </div><!-- .formatted -->
                </article>
