 ...
 */
wp_register_style( 'fusion', get_bloginfo( 'template_directory' ) . '/theme-options.css', '', '0.1' );
 ...
 * Set default options
 */
function fusion_default_options() {
	$options = get_option( 'fusion_theme_options' );

	if ( ! isset( $options['post_length'] ) ) {
		$options['post_length'] = 'full-post';
		update_option( 'fusion_theme_options', $options );
	}
	...
	if ( ! isset( $options['flexible_layout'] ) ) {
		$options['flexible_layout'] = 'fixed';
		update_option( 'fusion_theme_options', $options );
	}
}
add_action( 'init', 'fusion_default_options' );
...
function fusion_theme_options_do_page() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<?php $options = get_option( 'fusion_theme_options' ); ?>
