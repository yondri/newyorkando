...
function wptouch_footer_credits() {
	printf( __( 'Theme: %1$s by %2$s.', 'wptouch' ), 'WPtouch', '<a href="http://www.bravenewcode.com/wptouch/" rel="designer">BraveNewCode</a>' );
	echo '<br /><a href="http://wordpress.com/" rel="generator">Get a free blog at WordPress.com</a>';
}
add_action( 'wp_footer', 'wptouch_footer_credits', 5 );
