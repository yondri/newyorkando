...
<?php comments_number( '', '<h3 onclick="bnc_showhide_coms_toggle();" id="com-head"><img id="com-arrow" src="' . get_template_directory_uri() . '/core/core-images/com_arrow.png" alt="arrow" />'.__('1 Comment', 'wptouch').'</h3>', '<h3 onclick="bnc_showhide_coms_toggle();" id="com-head"><img id="com-arrow" src="' . get_template_directory_uri() . '/core/core-images/com_arrow.png" alt="arrow" />'.__('% Comments', 'wptouch').'</h3>' ); ?>
	...
	<?php
	 ...
	 if ( file_exists($filename) ) { ?>
		...
		<div id="refresher" style="display:none;">
			<img src="<?php echo get_template_directory_uri(); ?>/images/good.png" alt="checkmark" />
	...
	<?php endif; ?>
		...
		<input name="submit" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e( 'Publish' ); ?>" />
			...
			<div id="loading" style="display:none">
				<img src="<?php echo get_template_directory_uri(); ?>/core/core-images/comment-ajax-loader.gif" alt="" />
			</div>
		</p>
