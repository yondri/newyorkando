...
<!-- #start The Search / Menu Drop-Down -->
	<div id="wptouch-menu" class="dropper"> 
        ...
        <div id="wptouch-menu-inner">
			<ul>
				<li><a href="<?php bloginfo('url'); ?>"><img class="pageicon" src="<?php echo apply_filters( 'wpcom_wptouch_home_image', bnc_get_title_image() ); ?>" alt="pageicon" /><?php _e('Home'); ?></a></li>
			<?php
				...
				switch ( $num_pages->publish ) {
					...
					case 3:
						...
						break;
					default:
						echo '<li><a href="' . get_bloginfo('url') . '?pages-list"><img class="pageicon" src="' . get_stylesheet_directory_uri() . '/images/icon-pool/Default.png" alt="pageicon" />' . __('Pages') . '</a></li>';
						break;
					}

				echo '<li><a href="' . get_bloginfo('url') . '?archives-list=1"><img class="pageicon" src="' . get_stylesheet_directory_uri() . '/images/icon-pool/Archives.png" alt="pageicon" />' . __('Archives') . '</a></li>';
			?>
			</ul>
        </div>
	</div>
