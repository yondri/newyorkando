	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Dark color scheme', 'wu-wei' ); ?></th>
					<td>
						...
						<label class="description" for="wuwei_theme_options[colorscheme]"><?php _e( 'I&rsquo;d like to use the dark color scheme!', 'wu-wei' ); ?></label>
					</td>
				</tr>
