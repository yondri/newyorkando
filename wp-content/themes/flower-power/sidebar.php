...
<?php if (is_home() || is_page() || is_single() || is_page("archives") || is_archive() || is_search()) { ?>
	...
	<form action="<?php bloginfo('url'); ?>/" method="get">
			<input style="width:120px;" value="<?php the_search_query(); ?>" name="s" id="s" />
			<div style="padding:3px 0px 0px 0px;"></div>
			<input style="width:100px;font-size:11px;font-family:Arial,Verdana;" type="submit" value="<?php esc_attr_e( 'Search', 'flower-power' ); ?>" id="searchbutton" name="searchbutton" />
	</form>
	</center>
